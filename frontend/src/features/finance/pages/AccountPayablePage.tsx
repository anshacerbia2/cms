    ...
    <div className="w-full space-y-8 animate-in fade-in duration-700 pb-10">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          ...
          <p className="text-muted-foreground text-xs sm:text-sm font-medium">Manage and track your accounts payable.</p>
        </div>
      </div>
      ...
      <div className="bg-white/60 backdrop-blur-sm p-8 rounded-2xl lg:rounded-3xl shadow-sm border border-primary/5 flex flex-col items-center justify-center min-h-[400px] text-center">
        <ArrowDownRight className="w-16 h-16 text-primary/20 mb-4" />
        <h2 className="text-xl font-bold text-slate-700 mb-2">Account Payable Module</h2>
        <p className="text-slate-500 max-w-md">The Account Payable dashboard and management interface is currently under construction. Please check back later.</p>
      </div>
    </div>
  );
}
