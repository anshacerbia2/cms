        ...
        <div className="overflow-x-auto">
          <Table>
            <TableHeader className="bg-primary/[0.02]">
                ...
                <TableHead className="pl-8 text-[10px] font-extrabold uppercase tracking-[0.2em] text-primary/60">Menu</TableHead>
                <TableHead className="w-[240px] text-[10px] font-extrabold uppercase tracking-[0.2em] text-primary/60">Permission Route</TableHead>
                <TableHead className="w-[100px] text-[10px] font-extrabold uppercase tracking-[0.2em] text-primary/60">Order</TableHead>
                <TableHead className="w-[120px] text-[10px] font-extrabold uppercase tracking-[0.2em] text-primary/60">Roles</TableHead>
            ...
            <TableBody>
              {menusQuery.isLoading ? (
                ...
                rows.map(({ menu, depth }) => (
                  <TableRow key={menu.id} className="group hover:bg-primary/[0.02] border-primary/5 transition-all whitespace-nowrap">
                    <TableCell className="pl-8">
                      <div
