...
export async function seedAuth(prisma: PrismaClient) {
  ...
  const permissions = [
    ...
    { name: 'Bank Mutation', route: 'finance.bank-mutation' },
  ...
  const menuGroups = [
    ...
    { id: 400, name: 'Finance', icon: 'Landmark', order: 4, forFinance: true, items: [
      ...
      { id: 4003, name: 'Account Payable', icon: 'ArrowUpRight', route: 'finance.account-payable', order: 3, forFinance: true },
      { id: 4004, name: 'Account Receiveable', icon: 'ArrowDownRight', route: 'finance.account-receivable', order: 4, forFinance: true },
      ...
      { id: 4007, name: 'Sales', icon: 'ShoppingCart', route: 'sales.index', order: 7, forFinance: true },
    ]},
